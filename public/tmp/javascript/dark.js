...
function dark_mode(isDark){
    if(isDark){
        document.getElementById('dark').innerHTML = `<link href="http://localhost:8000/tmp/assets/css/bootstrap-dark.min.css" id="bootstrap-style" rel="stylesheet" type="text/css">
        <!-- App Css-->
        <link href="http://localhost:8000/tmp/assets/css/app-dark.min.css" id="app-style" rel="stylesheet" type="text/css">`
