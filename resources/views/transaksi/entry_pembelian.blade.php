                ...
                <form action="">
                    ...
                    <div>
                        <label for="">Bonus</label>
                            <input type="number" value="0" class="form-control" placeholder="" aria-label="Example text with button addon" value="">
                    </div>
                    ...
                    <table class="table table-striped" id="stoklimit" style="font-size: 13px;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>2</td>
                                <td>
                                    <a href="" class="btn btn-sm btn-primary mb-2"><i class="fas fa-pencil-alt"></i></a>
                                    <a href="" class="btn btn-sm btn-danger mb-2"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
