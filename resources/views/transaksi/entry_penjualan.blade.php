            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="#" style="width: 100%;" onclick="printSaleWithEpson()" class="btn btn-secondary btn-block">Epson</a>
                        </div>
                    </div>
                </div>
            </div>
...
@section('c_print')
    @if (old('print_s_penjualan'))
        <?php $id = old('print_s_penjualan');
        $sale = \App\Models\Sale::find($id);
        $company = \App\Models\Company_profile::find(1);
            $sale_detail = \App\Models\Sale_detail::where('sale_id', $sale->id)->get();
            $footer = \App\Models\Setting::where('options', 'footer_nota_sale_ep')->first();
            $foot = str_replace("{ent}","`+'\x0A'+`",$footer);
        ...
        <script>
            ...
            const foot_text = footer.replace('{ent}', "'+'\x0A'+'")
            console.log(`${foot_text}`);
            var sale_detail = <?php echo $sale_detail; ?>;
            console.log(sale_detail)
        function printSaleWithEpson() {
